  ...
  if (!(0,_state__WEBPACK_IMPORTED_MODULE_1__/* .isLikesDisabled */ .$L)()) {
    ...
    if (!(0,_state__WEBPACK_IMPORTED_MODULE_1__/* .isShorts */ .ol)()) {
      if (!rateBar && !(0,_state__WEBPACK_IMPORTED_MODULE_1__/* .isMobile */ .tq)()) {
        ...
        let actions = (0,_state__WEBPACK_IMPORTED_MODULE_1__/* .isNewDesign */ .am)() && (0,_buttons__WEBPACK_IMPORTED_MODULE_0__/* .getButtons */ .hS)().id === "top-level-buttons-computed"
          ? (0,_buttons__WEBPACK_IMPORTED_MODULE_0__/* .getButtons */ .hS)() : document.getElementById("menu-container");
        (
...
function getLikeButton() {
  return getButtons().children[0].tagName ===
    'YTD-SEGMENTED-LIKE-DISLIKE-BUTTON-RENDERER'
      ? (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* .querySelector */ .R2)(_state__WEBPACK_IMPORTED_MODULE_0__/* .extConfig */ .zO.selectors.buttons.likeButton.segmented) ?? (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* .querySelector */ .R2)(_state__WEBPACK_IMPORTED_MODULE_0__/* .extConfig */ .zO.selectors.buttons.likeButton.segmentedGetButtons, getButtons())
...
function getDislikeButton() {
  ...
  'YTD-SEGMENTED-LIKE-DISLIKE-BUTTON-RENDERER'
    ...
    : (0,_state__WEBPACK_IMPORTED_MODULE_0__/* .isShorts */ .ol)() ? (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* .querySelector */ .R2)(['#dislike-button'], getButtons()) : (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* .querySelector */ .R2)(_state__WEBPACK_IMPORTED_MODULE_0__/* .extConfig */ .zO.selectors.buttons.dislikeButton.notSegmented, getButtons())
}
...
/* unused harmony export createStarRating */
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(67);
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(67);
/* harmony import */ var _starRating__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(376);
/* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(27);
...
function isVideoLiked() {
  if (isMobile()) {
    return (
      (0,_buttons__WEBPACK_IMPORTED_MODULE_0__/* .getLikeButton */ .yN)().querySelector("button").getAttribute("aria-label") === "true"
    );
  }
  return (0,_buttons__WEBPACK_IMPORTED_MODULE_0__/* .getLikeButton */ .yN)().classList.contains("style-default-active") || (0,_buttons__WEBPACK_IMPORTED_MODULE_0__/* .getLikeButton */ .yN)().querySelector('button')?.getAttribute('aria-pressed') === 'true';
}

function isVideoDisliked() {
  if (isMobile()) {
    return (
      (0,_buttons__WEBPACK_IMPORTED_MODULE_0__/* .getDislikeButton */ .x8)().querySelector("button").getAttribute("aria-label") === "true"
    );
  }
  return (0,_buttons__WEBPACK_IMPORTED_MODULE_0__/* .getDislikeButton */ .x8)().classList.contains("style-default-active") || (0,_buttons__WEBPACK_IMPORTED_MODULE_0__/* .getDislikeButton */ .x8)().querySelector('button')?.getAttribute('aria-pressed') === 'true';
}
...
function getLikeCountFromButton() {
  try {
    ...
    let likeButton = (0,_buttons__WEBPACK_IMPORTED_MODULE_0__/* .getLikeButton */ .yN)()
...
function displayError(error) {
  (0,_buttons__WEBPACK_IMPORTED_MODULE_0__/* .getDislikeTextContainer */ .xP)().innerText = (0,_utils__WEBPACK_IMPORTED_MODULE_2__/* .localize */ .NC)(
    "textTempUnavailable"
  );
}
...
function numberFormat(numberState) {
  return getNumberFormatter(_state__WEBPACK_IMPORTED_MODULE_0__/* .extConfig */ .zO.numberDisplayFormat).format(
    numberState
  );
}
